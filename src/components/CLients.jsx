...
export default function CLients() {
  ...
  return (
    <div className="p-4 dark:bg-purple-900 dark:text-white">
      <h2 className="text-2xl font-semibold mb-4">Clientes</h2>
      <div className="bg-white p-4 rounded shadow dark:bg-[#C2A3D1] dark:text-black">
              ...
              >
                <div className="grid gap-2 md:grid-cols-2">
                  ...
                  <div className="flex items-center justify-center mt-4">
                    ...
                    >
                      {client.deletedAt?"Restaurar":"Eliminar"}
                    </button>
                  </div>
                </div>
              </li>
