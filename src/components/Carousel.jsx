        ...
        <div className="max-w-2xl m-auto">
            <Slider {...config}>
                <div className="relative">
                    <img src={Fondo} className="block w-full h-96 object-cover rounded-3xl" alt="Fondo 1" />
                ...
                <div className="relative">
                    <img src={Fondo} className="block w-full h-96 object-cover rounded-3xl" alt="Fondo 2" />
                    <span className="absolute p-8 inset-0 flex items-center justify-center text-2xl font-semibold text-white sm:text-3xl dark:text-gray-800">
                ...
                <div className="relative">
                    <img src={Fondo} className="block w-full h-96 object-cover rounded-3xl" alt="Fondo 3" />
                    <span className="absolute p-8 inset-0 flex items-center justify-center text-2xl font-semibold text-white sm:text-3xl dark:text-gray-800">
