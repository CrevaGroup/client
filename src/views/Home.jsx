    ...
    <div className="bg-custom-gray">
      <div className="flex flex-col lg:flex-row">
        <div className="lg:w-1/2 lg:pr-10 mt-10 ml-10">
          ...
          <h2 className="text-l"> Si buscás asistencia online para potenciar tu busqueda</h2>
          <h2 className="text-l">de crecimiento laboral,</h2>
          <h2 className="text-l">¡Bienvenid@, llegaste al lugar indicado!</h2>
          <SearchBar />
        </div>
        <div className="lg:w-1/2 mt-10 lg:mt-0 mx-auto">
          <img src={Consulting} alt="Consulta" className="rounded-lg object-cover object-center" style={{ width: `550px` }} />
        </div>
      </div>
